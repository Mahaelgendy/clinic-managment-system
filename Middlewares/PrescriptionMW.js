...
exports.prescriptionValidation=[ 
    ...
    body("currentExamination").isDate().notEmpty().withMessage("appointment date is required"),
    body("nextExamination").isDate().withMessage(" next consiled date is required"),
